...
import {
  ...
  AlertTriangle, ShieldAlert, Download, Table
} from "lucide-react";
                        ...
                        <div className="flex items-center justify-end space-x-2">
                          {isLocked && (
                            <button
                              ...
                              className="px-3 py-1 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-[11px] rounded-lg transition shadow-2xs flex items-center space-x-1"
                            >
