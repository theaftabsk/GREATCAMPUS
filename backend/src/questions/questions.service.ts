  ...
  async seed30OfficialQuestions() {
    ...
    if (!assessment) {
      ...
      await this.prisma.assessment.update({
        ...
        data: { durationMins: 22, passingPercentage: 50 },
      });
    }
    ...
    return {
      success: true,
      message: 'Re-seeded question bank with 30 official questions.',
      count,
      assessmentDurationMins: 22,
    };
  }
}
