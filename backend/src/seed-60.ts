...
const all60Questions = [
  // ==========================================
  // SET 1: ASSISTANT RELATIONSHIP MANAGER – BANCA CHANNEL (Q1 - Q30)
  // ==========================================
  ...
  // ==========================================
  // SET 2: AGENCY UNIT MANAGER – GRADUATE & POST-GRADUATE ASSESSMENT (Q31 - Q60)
  // ==========================================

  // Section 1: Communication & Comprehension (Q31 - Q35)
  {
  ...
  // Section 2: Advanced English (Q36 - Q40)
  {
    sectionName: 'Advanced English',
    sectionOrder: 2,
    question: `Choose the grammatically correct sentence.`,
    optionA: `Neither the manager nor the advisors was aware of the change.`,
    ...
    optionD: `Neither the manager or the advisors were aware of the change.`,
    correctAnswer: 'C',
    marks: 1,
  },
  {
  ...
  // Section 3: Mental Ability & Reasoning (Q41 - Q45)
  {
    sectionName: 'Mental Ability & Reasoning',
    sectionOrder: 3,
  ...
  // Section 4: Applied Mathematical Reasoning (Q46 - Q50)
  {
  ...
  },
  {
    sectionName: 'Applied Mathematical Reasoning',
    sectionOrder: 4,
    question: `A branch has a target of 500 policies. At the end of the month: • Advisor A achieves 120% of an individual target of 100. • Advisor B achieves 90% of a target of 150. • Advisor C achieves 80% of a target of 150. • The remaining advisors together achieve 95 policies. How many policies has the branch achieved?`,
    optionA: `435`,
    optionB: `445`,
    optionC: `455`,
    optionD: `465`,
  ...
  },
  {
    sectionName: 'Applied Mathematical Reasoning',
    sectionOrder: 4,
    question: `A branch receives 1,000 leads. • 70% are contacted. • 60% of contacted leads are qualified. • 50% of qualified leads attend a meeting. • 40% of meetings result in proposals. • 75% of proposals convert. How many policies are expected?`,
    optionA: `54`,
    optionB: `60`,
    optionC: `63`,
    optionD: `70`,
  ...
  // Section 5: Sales Orientation & Job Readiness (Q51 - Q55)
  {
  ...
  // Section 6: Applied Insurance Awareness (Q56 - Q60)
  {
...
async function main() {
  console.log('Starting 60-Question Seeder for Niva Bupa Candidate Assessment Platform...');
  ...
  let assessment = await prisma.assessment.findFirst({ where: { slug: 'aa-2812' } });
  if (!assessment) {
  ...
  console.log(`Inserting ${all60Questions.length} official questions...`);
  ...
  console.log(`=== SUCCESS! TOTAL 60 QUESTIONS SEEDED SUCCESSFULLY IN DATABASE: ${count} ===`);
}

main()
  .then(() => process.exit(0))
  .catch((err) => {
    console.error('SEED 60 ERROR:', err);
    process.exit(1);
  });
